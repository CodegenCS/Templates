...
/// <summary>
/// This console application invokes the template DapperActiveRecordPocos.cs 
...
///     dotnet-codegencs template run DapperActiveRecordPocos.cs <DbSchema.json> <Namespace> [options]
///
...
internal class MyTemplate
{
    ...
    static void Main(string[] args)
    {
        ...
        var ctx = new CodegenContext("DapperActiveRecordPocos.generated.cs");
