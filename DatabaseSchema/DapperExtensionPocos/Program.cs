...
/// <summary>
/// This console application invokes the template DapperExtensionPocos.cs 
...
///     dotnet-codegencs template run DapperExtensionPocos.cs <DbSchema.json> <Namespace> [options]
///
...
internal class MyTemplate
{
    ...
    static void Main(string[] args)
    {
        ...
        var ctx = new CodegenContext("DapperExtensionPocos.generated.cs");
