...
/// <summary>
/// This console application invokes the template SimplePocos.cs 
...
///     dotnet-codegencs template run SimplePocos.cs <DbSchema.json> <Namespace> [options]
///
...
internal class MyTemplate
{
    ...
    static void Main(string[] args)
    {
        ...
        var ctx = new CodegenContext("SimplePocos.generated.cs");
        
        var templateOptions = new SimplePOCOGenerator.SimplePOCOGeneratorOptions()
        {
        ...
        var template = new SimplePOCOGenerator(new ColoredConsoleLogger(), templateOptions);
