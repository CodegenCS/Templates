...
/// <summary>
/// This console application invokes the template EFCoreGenerator.cs 
...
///     dotnet-codegencs template run EFCoreGenerator.cs <DbSchema.json> <Namespace> [options]
///
...
internal class MyTemplate
{
    ...
    static void Main(string[] args)
    {
        ...
        var ctx = new CodegenContext("EFCoreGenerator.generated.cs");
        
        var templateOptions = new EFCoreGenerator.EFCoreGeneratorOptions()
        {
            ContextName = "MyContext",
            EntitiesNamespace = "MyNamespace",
        };

        //ctx.DefaultOutputFile.RelativePath = "MyEntities.cs"; templateOptions.SingleFile = true;  // generate everything in a single file

        var template = new EFCoreGenerator(new ColoredConsoleLogger(), templateOptions);
