...
/// <summary>
/// SimplePocos.cs: Generates simple POCOs based on a Database Schema (just classes and properties, no relationships).
///
/// Usage: dotnet-codegencs template run SimplePocos.cs <DbSchema.json> <Namespace> [--SingleFileName <file>] [-t <true/false>] [-k <true/false>] [-db <true/false>] [-eq <true/false>]
...
///
/// Options:
///   --SingleFileName <SingleFileName>      If defined, all POCOs will be generated under this single filename
...
public class SimplePOCOGenerator : ICodegenMultifileTemplate<DatabaseSchema>
{
    ...
    public static void ConfigureCommand(Command command)
    {
        ...
        command.AddOption(new Option<string>(new string[] { "--SingleFileName"/*, "-f"*/}) { Arity = ArgumentArity.ZeroOrOne, Description = "If defined, all POCOs will be generated under this single filename\nExample: \"POCOs.Generated.cs\"" });
        command.AddOption(new Option<bool>(new string[] { "--AddTableAttribute", "-t" }, getDefaultValue: () => true) { Description = "If true will add [Table] attributes to POCOs." });
        command.AddOption(new Option<bool>(new string[] { "--AddKeyAttribute", "-k" }, getDefaultValue: () => true) { Description = "If true will add [Key] attributes to primary-key columns.\nThis is required by FastCRUD and Entity Framework" });
        command.AddOption(new Option<bool>(new string[] { "--AddDatabaseGeneratedAttribute", "-db" }, getDefaultValue: () => true) { Description = "If true will add [DatabaseGenerated] attributes to identity and computed columns.\nThis is required by FastCRUD and Entity Framework" });
        command.AddOption(new Option<bool>(new string[] { "--GenerateEqualsHashCode", "-eq" }, getDefaultValue: () => true) { Description = "If true POCOs will have override Equals/GetHashCode and equality/inequality operators (== and !=)" });
    }
    ...
    public class SimplePOCOGeneratorOptions : IAutoBindCommandLineArgs
    {
        ...
        /// <summary>
        /// If defined, all POCOs will be generated under this single filename
        /// Example: "POCOs.Generated.cs"
        /// </summary>
    ...
    public void GeneratePOCOs(DatabaseSchema schema)
    {
        ...
        {
            var singleFile = _generatorContext[_options.SingleFileName];
